...
export default function SchoolsPage() {
  const schools = [
    { id: 1, name: "GHSS Chararsharief", location: "Chararsharief" },
    { id: 2, name: "MS Kultreh", location: "Kultreh" },
    { id: 3, name: "MS Ohangam", location: "Ohangam" },
    { id: 4, name: "MS Thazwooder", location: "Thazwooder" },
    { id: 5, name: "HS Dharmuna", location: "Dharmuna" },
    { id: 6, name: "MS Shankerpora", location: "Shankerpora" },
    { id: 7, name: "BMS Chararsharief", location: "Chararsharief" },
    { id: 8, name: "BMS Khansahib", location: "Khansahib" },
    { id: 9, name: "HSS Wagar", location: "Wagar" },
    { id: 10, name: "HSS Kanir", location: "Kanir" },
    { id: 11, name: "HSS Gogjipathri", location: "Gogjipathri" },
    { id: 12, name: "HS Rawalpora", location: "Rawalpora" },
    { id: 13, name: "Hr Sec School Shogapora", location: "Shogapora" },
